...
if(isset($_GET['Blog'])) {
	$IdBlog = $_GET['Blog'];
  $Qeurypost = "SELECT * FROM `blog` where IdBlog = ".$IdBlog; 
...
<html lang="en">
  <head>
    ...
    <title>Morocco Sand Tours - Morocco Sand Tours and travel site template by Ansonika</title>

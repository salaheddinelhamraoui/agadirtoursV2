...
if(isset($_GET['delete_blog'])){
  ...
  if($delete_blog){
  echo "<script>alert('La publication a été supprimée avec succès!')</script>";
...
if(isset($_POST['deleteAll'])){
  ...
  if($run_remove){
  echo "<script>alert('Les publications sélectionnés ont été supprimés avec succès!')</script>";

  ...
  <body>
    ...
    <main>
      ...
      <div class="main_title">
          ...
          <p>
          We offer low-cost transfers to and from major airports across
            Morocco. Our vehicles are comfortable, reliable and at very
            attractive prices and our drivers are well experienced and very
            helpful. </p>
        </div>
        <div class="row">
          <div class="col-md-8">
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <textarea
                        ...
                        class="form-control"
                        placeholder="some details about your trip :)"
                        style="height: 200px"
                      ></textarea>
                    </div>
                  </div>

...
<html lang="en">
  <head>
    ...
    <meta
      name="description"
      content="CUSTOMIZED MOROCCO TOURS
	  "
    />

    <title>CUSTOMIZED MOROCCO TOURS</title>
  ...
  <body>
    ...
    <section
      ...
      data-image-src="https://www.moroccofirstgate.com/wp-content/uploads/2018/04/Rugs_Girl_Chefchaouen_Morocco.jpg"
      data-natural-width="1400"
      data-natural-height="470"
    >
      <div class="parallax-content-1">
        <div class="animated fadeInDown">
          <h1>CUSTOMIZED MOROCCO TOURS</h1>
          <p>Travel Differently With us</p>
        </div>
      </div>
    </section>
    <!-- End Section -->
    ...
    <main>
      ...
      <div class="main_title">
          <h2>CUSTOMIZED <span>MOROCCO</span>  TOURS & PACKAGES</h2>
          <p>
          CUSTOMIZED MOROCCO TOURS : You don’t want to travel all the way to an exotic land to be bused around in a large group tour.  Morocco Sand Tours Tours offers you authentic custom designed Morocco Tours, with access to the best high-end Tours that will lavish your memory with vivid colors and experiences you will never forget. Our travel experts will create a personalized itinerary based on your individual interests and budget.
        ...
        <div class="row">
          <div class="col-md-8">
            <div class="form_title">
              <h3>
                <strong><i class="icon-pencil"></i></strong>Fill the form below
              </h3>
              <p>
                If you have any questions, pre-sale questions or any problem,
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <textarea
                        ...
                        class="form-control"
                        placeholder="Your message(Number of adults & children /Number & type of rooms/Accommodation category[Standard or superior ] /Your country / pick up & drop off cities ...)"
                        style="height: 200px"
                      ></textarea>
                    </div>
                  </div>
